                            ...
                            <form action="" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <select class="form-control" name="status" required>
                                                ...
                                                <option {{ (old('status',  $teacher->status)==0) ? 'selected' : '' }} value="0">In Active</option>
                                                <option {{ (old('status',  $teacher->status)==1) ? 'selected' : '' }} value="1">Active</option>
                                            </select>
                                ...
                                <div class="card-footer">
                                    <div class="row justify-content-center">
                                        <button type="submit" class="btn btn-primary col-4">Update Teacher</button>
                                      </div>
